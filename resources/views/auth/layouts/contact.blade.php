...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="fname" type="text" name="fname" value="{{ $user->fname }}" class="form-control" required>    
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="lname" type="text" name="lname" value="{{ $user->lname }}" class="form-control" required>    
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="title_academic" name="title_academic" value="{{ $user->title_academic }}" type="text" class="form-control">    
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="title_photo" name="title_photo" type="text" value="{{ $user->title_photo }}" class="form-control">
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="street" type="text" name="street" value="{{ $user->street }}" class="form-control">    
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="postal_code" name="postal_code" value="{{ $user->postal_code }}" type="text" class="form-control">        
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
    @if (auth()->user())
        <input id="city" type="text" name="city" value="{{ $user->city }}" class="form-control" required>            
    @else
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        ...
        @foreach (\App\Models\Country::all() as $item)
            @if (auth()->user())
                <option value="{{ $item->id }}" @if ($user->country_id == $item->id) {{ "selected" }} @endif > {{ $item->country }} </option>
            @else
